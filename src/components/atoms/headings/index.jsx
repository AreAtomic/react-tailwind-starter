export const HeadingOne = (props) => {
  return (
    <h1 className={`text-5xl ${props.color || 'text-purple-areatomic-500'}`}>
      {props.children}
    </h1>
  );
};
...
export const HeadingTwo = (props) => {
  return (
    <h2 className={`text-3xl ${props.color || 'text-purple-areatomic-500'}`}>
      {props.children}
    </h2>
  );
};
...
export const HeadingThree = (props) => {
  return (
    <h3 className={`text-2xl ${props.color || 'text-purple-areatomic-500'}`}>
      {props.children}
    </h3>
  );
};
...
export const HeadingSix = (props) => {
  return (
    <h6 className={`text-base ${props.color || 'text-purple-areatomic-500'}`}>
      {props.children}
    </h6>
  );
};
